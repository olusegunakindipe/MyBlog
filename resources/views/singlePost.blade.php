        ...
        <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="post__content">
                    ...
                    <div class="post-additional-info">
                        ...
                        <span class="category">
                            ...
                            <a href="{{route('single.category',$post->category->id)}}">{{$post->category->name}}</a>
                        </span>
            ...
            <div class="blog-details-author">
                ...
                <div class="blog-details-author-thumb">
                    <img src="{{asset($post->user->profile->avatar)}}" alt="Author" width="80px" height="50px" style="border-radius:100px">
                </div>
            ...
            <div class="pagination-arrow">
                ...
                @if($prev)
                    <a href="{{route('single', $prev->slug)}}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                ...
                @endif
                @if($next)
                    <a href="{{route('single', $next->slug)}}" class="btn-next-wrap">
                        <div class="btn-content">
